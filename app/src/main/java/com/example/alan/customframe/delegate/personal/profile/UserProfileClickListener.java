...
import com.example.alan.customframe.util.DateDialogUtil;
...
import com.example.alan.customframe.util.callback.IGlobalCallback;
                ...
                CallbackManager.getInstance()
                        .addCallback(CallbackType.ON_CROP, new IGlobalCallback<Uri>() {
                            ...
                            public void executeCallback(Uri args) {
                                ...
                                final ImageView avatar = (ImageView) view.findViewById(R.id.img_arrow_image);
                                Glide.with(DELEGATE)
                                        .load(args)
                                        .into(avatar);
            ...
            case 3:
                getGenderDialog(new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        final TextView textView = (TextView) view.findViewById(R.id.list_item_avatar_value);
